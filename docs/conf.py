...
htmlhelp_basename = 'NRELTrainingDoc'
...
man_pages = [
    (master_doc, 'nreltraining', u'NREL Training Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'NREL Training', u'NREL Training Documentation',
